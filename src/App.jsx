          ...
          <div className="header-inner">
            <div className="header-brand" onClick={() => { setQuery(''); navigate('/'); }}>
              <div className="logo flex items-center gap-2">
                <span className="logo-icon text-[#6366f1] animate-pulse">
                  <svg
                ...
                <span className="logo-text font-display font-extrabold text-xl text-white tracking-widest">CINEMATE</span>
              </div>
            </div>
